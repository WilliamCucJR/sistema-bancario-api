...
builder.Services.AddDbContext<MovimientosTable>(options =>
{
    options.UseOracle(builder.Configuration.GetConnectionString("OracleDB"));
});
...
builder.Services.AddDbContext<CuentaBancariaTable>(options =>
{
    options.UseOracle(builder.Configuration.GetConnectionString("OracleDB"));
});

builder.Services.AddDbContext<DepartamentoTable>(options =>
{
    options.UseOracle(builder.Configuration.GetConnectionString("OracleDB"));
});
...
builder.Services.AddDbContext<MovPorDescripcionTable>(options =>
{
    options.UseOracle(builder.Configuration.GetConnectionString("OracleDB"));
});
...
builder.Services.AddDbContext<CashFlowTable>(options =>
{
    options.UseOracle(builder.Configuration.GetConnectionString("OracleDB"));
});

builder.Services.AddDbContext<EstadoDeCuentaTable>(options =>
{
    options.UseOracle(builder.Configuration.GetConnectionString("OracleDB"));
});
